<section class="promo-info">
    ...
    <div class="wrap container-fluid">
        <div class="row promo-info__container">
            ...
            <div class="col col-xl-4 col-md-6 col-sm-12 promo-info__amount">
                <button type="button" class="btn-more btn-more--long btn-more--uppercase btn-more--gold" data-popup-link="booking-popup">
                    {{ __('event.ticket_booking_text') }}
                </button>
    ...
    @if($media = $calendar->getFirstMedia('poster1') ? $calendar->getFirstMedia('poster1') : $calendar->performance->getFirstMedia('posters'))
        <figure class="promo-info__img">
            <img src="{{ $media->getUrl('slider') }}"
