    ...
    <li class="filter__item col-sm-6 col-xl-3" data-filter-item="scene">
      ...
      <ul class="filter__item-list" data-filter-list>
        <li><a href="{{ route('front.calendar.index') }}">{{ __('calendar.scene') }}</a></li>
          ...
          @endforeach
{{--        <li><a href="{{ route('front.calendar.index', ['scene' => 'big']) }}#/calendar?scene=big">{{ __('calendar.big_scene') }}</a></li>
        <li><a href="{{ route('front.calendar.index', ['scene' => 'small']) }}#/calendar?scene=small">{{ __('calendar.small_scene') }}</a></li>
        <li><a href="{{ route('front.calendar.index', ['scene' => 'open']) }}#/calendar?scene=outdoor">{{ __('calendar.open_scene') }}</a></li>
        <li><a href="{{ route('front.calendar.index', ['scene' => 'chamber']) }}#/calendar?scene=muzsalon">{{ __('calendar.chamber_scene') }}</a></li>
